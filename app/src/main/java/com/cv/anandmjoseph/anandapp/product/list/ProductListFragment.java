...
import com.cv.anandmjoseph.anandapp.core.fragments.FragmentViewStateFragment;
...
import com.cv.anandmjoseph.anandapp.product.details.ProductDetailsFragment;
...
public class ProductListFragment extends FragmentViewStateFragment<ViewState, ProductListView,
    ...
    void showProductDetails(final int position){
        ...
        transaction.mInAnimation = R.anim.abc_slide_in_bottom;
        transaction.mOutAnimation = R.anim.abc_fade_out;
